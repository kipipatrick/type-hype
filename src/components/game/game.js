...
let Game = ()=>{
    ...
    return (
        ...
        <div style={{color: 'white', fontSize: 14, marginTop: 10, marginBottom: 10, minHeight: '30vh'}}>
        {
            ...
            {
                scores.sort((a,b)=> b.score -a.score).slice(0,5).map((item, key)=>{
        ...
        { !showTest?<div style={{fontSize: 14, color: 'white', marginTop: '10vh', fontWeight: 400, width: '50%'}}>
        Tests the your typing sped and accuracy. Try it now to see how many correct words you can type in a minute. Get a free assessment after your type test--are you all hype or can you really type?
        </div>: ''}
        
        
        <div style={{color: 'white', fontSize: 16, fontWeight: "bold", marginTop: '10vh', marginBottom: '5vh', display: showTest? 'none': ""}}><Button  size='large' style={{ background: '#8E6AAC', color:'white'}} onClick={()=>setShowTest(true)}>Start Typing Test</Button></div>
